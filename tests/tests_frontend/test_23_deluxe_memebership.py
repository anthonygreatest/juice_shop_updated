...
from tests.tests_frontend.frontend_helpers import log_out_and_log_in, find_out_product_price
...
class TestDeluxeMembership:
    def test_membership_text_appears_on_page_and_fee_is_paid(
        self,
        deluxe_membership_page,
        sum_deposited_into_e_wallet,
        digital_wallet,
    ...
    def test_deluxe_membership_offers_sales(
        self,
        put_product_into_basket,
        basket_page,
    ...
    @pytest.mark.delete_product
    def test_deluxe_membership_offers_free_fast_delivery(
        self,
        get_headers,
        create_address,
        put_product_into_basket,
